...
private:
    ...
    double motion_variance_; // The variance of the robots motion, only estimation for configuring the Kalman filter
    double measurement_variance_; // The variance of the inertial sensor, only estimation for configuring the Kalman filter
