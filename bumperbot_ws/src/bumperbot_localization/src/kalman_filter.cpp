...
{
    mean_ = (measurement_variance_ * mean_ + variance_ * imu_angular_z_) / (measurement_variance_ + variance_);
    variance_ = (variance_ * measurement_variance_) / (measurement_variance_ + variance_);
}
